...
<html lang="en">
  ...
  <body>
    ...
    <header class="clearfix" style="width:88%;">
      ...
      <table style="width:88%">
        <thead>
          <tr>
            ...
            <th class="service">Nama Kantin</th>
            <th class="desc">Kategori</th>
            <th class="service">Harga</th>
            <th class="service">Transaksi</th>
            <th class="service">Omset</th>
          </tr>
        </thead>
        <tbody>
			<?php foreach($produk as $produk){?>
          <tr>
            <td class="service"><?= $produk->nama_kantin ;?></td>
	  ...
	  <header class="clearfix" style="width:88%;">
      <h1>Omset Kantin Bulan <?= date("M");?></h1>
      </header>
	   <table style="width:88%">
        <thead>
          <tr>
            <th class="service">Nama Kantin</th>
            <th class="service">Asal Sekolah</th>
            <th class="desc">Pemilik</th>
            <th class="service">Rating</th>
            <th class="service">Transaksi</th>
            <th class="service">Omset</th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            <td class="service"><?= $kantin->nama_kantin ;?></td>
            <td class="service"><?= $kantin->nama_sekolah ;?></td>
            <td class="desc"><?= $kantin->nama;?></td>
            <td class="service"><?= $kantin->penilaian;?></td>
            <td class="service"><?= $kantin->jml_transaksi ;?></td>
            <td class="service"><?= $kantin->omset ;?></td>
          </tr>
			<?php }?>
        </tbody>
      </table>
