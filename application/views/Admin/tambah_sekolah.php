						...
						<div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
										<form method="post" action="<?= base_url();?>index.php/Admin/Sekolah/aksi_tambah">
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="website" placeholder="Masukan Website Sekolah">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
													<textarea style="height:200px;" class="form-control" id="exampleInputEmail2" name="alamat" placeholder="Masukan Alamat Sekolah"></textarea>
